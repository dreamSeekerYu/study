...
function () {
  ...
  _proto.en = function en(oldStr, enKey) {
    ...
    var str = Base64.encode(encodeURIComponent(oldStr)); // 加密操作
    ...
    return enKey ? Base64.encode(newStr) : {
...
export { cookie$1 as cookie, crypto$2 as crypto, storage };
