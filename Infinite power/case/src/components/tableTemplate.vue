<template>
  <div class="table">
    ...
    <el-table
      ...
      :style="table.tableConfig ? table.tableConfig.style : ''"
      ...
      @current-change="table.tableConfig.handleCurrentChange || function() {}"
      @selection-change="
        table.tableConfig.handleSelectionChange || function() {}
      "
    >
      ...
      <!-- 多选展示 -->
      <el-table-column
        v-if="table.tableConfig.selection"
        type="selection"
        width="55"
      >
      </el-table-column>
