/*!OneAPM-v411.4.5 */ !
    ...
    function () {
        ...
        var a;
        window.BWEUM.require = a,
            window.apmFirstbyte = window.apmUserFirstbyte || (new Date).getTime(),
            a = function b(c, d, e) {
                function f(h, i) {
                    if (!d[h]) {
                        if (!c[h]) {
                ...
                34: [function (a, b) {
                    ...
                    var n = !1,
                        o = !1;
                    try { n = null == window.frameElement && document.documentElement } catch (m) { }
                    n && n.doScroll && ! function p() {
                        if (!o) {
                            try { n.doScroll("left") } catch (a) { return setTimeout(p, 50) }
                            o = !0, e()
                        }
                    }()
                },
                ...
                36: [function (a, b) {
                    function c(a, b, c) {
                        ...
                        for (var d = -1, e = c - b || 0, f = new Array(0 > e ? 0 : e);
                            ++d < e;
                        ) f[d] = a[b + d];
                        return f
                    }
            ...
            a = function c(b, d, e) {
                ...
                { errorload: 5, loader: 34, perfload: 6, xhrload: 7 }
                ],
                7: [function (a) {
                    function b(a) {
                        ...
                        try { return JSON.stringify(a).length } catch (b) { return void 0 }
                    }
                    ...
                    if (h && h.prototype && !/CriOS/.test(navigator.userAgent)) {
                        ...
                        var i = a("handle"),
                            ...
                            n = a("loader_id"),
                            o = a("wrap-function")(k);
                        a("wrap-events"), a("wrap-xhr"),
                            k.on("new-xhr", function () {
                                ...
                                if (this.startTime = (new Date).getTime(),
                                    this.listener = function (a) {
                                        try {
                                            "abort" === a.type && (f.params.aborted = !0),
                                                ("load" !== a.type || f.called === f.totalCbs && (f.onloadCalled || "function" != typeof c.onload)) && f.end && f.end(c)
                                        } catch (b) {
                                            try { k.emit("internal-error", [b]) } catch (d) { }
                                        }
                                    }, c.addEventListener)
                                ...
                                this.cbTime += a, b ? this.onloadCalled = !0 : this.called += 1,
                ...
                35: [function (a, b) {
                    function c(a) {
                        var b = typeof a;
                        return !a || "object" !== b && "function" !== b ? -1 : a === window ? 0 : f(a, e, function () { return d++ })
                    }
                    var d = 1,
                        e = "bw@id",
                        f = a("gos");
                ...
                5: [function (a) {
                    function b(a, b, d, g, i) {
                        try { j ? j -= 1 : e("err", [i || new c(a, b, d)]) } catch (k) {
                            try { e("ierr", [k, (new Date).getTime(), !0]) } catch (l) { }
                        }
                ...
                30: [function (a, b) {
                    ...
                    b.exports = g, window._ApmXMLHttpRequest = window.XMLHttpRequest, window.XMLHttpRequest = function (a) {
                        ...
                        } catch (d) { try { g.emit("internal-error", [d]) } catch (f) { } }
                        return b
                ...
                39: [function (a, b) {
                    ...
                    b.exports = function (a) {
                        ...
                        function h(a, b, c, d, e, f) {
                            var d, c, g, h;
                            try { g = e && e(d, c) || {} } catch (i) { m([i, "", [d, c, f], g]) }
                            _apmfnName = a.name || "", k(b + "start", [d, c, f, _apmfnName], g);
                            try { return h = a.apply(c, d) } catch (j) {
                            ...
                            } finally { k(b + "end", [d, c, h, _apmfnName], g) }
                        }
                            ...
                            if (Object.defineProperty && Object.keys) try {
                                ...
                                return c.forEach(function (c) {
                                    Object.defineProperty(b, c, {
                                        get: function () { return a[c] },
                                        set: function (b) { return a[c] = b, b }
                                    })
                                }), b
                            } catch (d) { m([d]) }
